...
func (m *KeyAuthChallenge) GetCipherText() []byte {
	if m != nil {
		return m.CipherText
	}
	return nil
...
func (m *KeyAuthChallenge) GetIV() []byte {
	if m != nil {
		return m.IV
	}
	return nil
...
func (m *KeyAuthChallengeReply) GetPlainText() []byte {
	if m != nil {
		return m.PlainText
	}
	return nil
...
var fileDescriptor_878fa4887b90140c = []byte{
	...
	,
}
...
func (m *KeyAuthChallenge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IV) > 0 {
		i -= len(m.IV)
		copy(dAtA[i:], m.IV)
		i = encodeVarintGossip(dAtA, i, uint64(len(m.IV)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.CipherText) > 0 {
		...
		i = encodeVarintGossip(dAtA, i, uint64(len(m.CipherText)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Y) > 0 {
...
func (m *KeyAuthChallengeReply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PlainText) > 0 {
		...
		i = encodeVarintGossip(dAtA, i, uint64(len(m.PlainText)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
